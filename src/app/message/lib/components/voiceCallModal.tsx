  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <button
        ...
        style={
          danger ? { boxShadow: "0 4px 18px rgba(239,68,68,0.4)" } : undefined
        }
      >
        {children}
      </button>
      ...
      <div
        className={[
          ...
          fullscreen
            ...
            : "w-full max-w-[360px] mx-4 rounded-[28px]",
        ].join(" ")}
        style={{
          background: "linear-gradient(160deg,#0d0d1f 0%,#0a0a18 100%)",
          border: "0.5px solid rgba(255,255,255,0.08)",
          boxShadow:
            "0 48px 96px rgba(0,0,0,0.85), inset 0 0 0 0.5px rgba(255,255,255,0.04)",
          transform: visible
        ...
        {isVideo && (
          ...
          >
            ...
            <video
              ...
              style={{
                display: isConnected && remoteStream ? "block" : "none",
              }}
            />
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top,rgba(10,10,24,0.9),transparent)",
              }}
            />
        ...
        >
          ...
          >
            {isSpeakerOn ? (
              ...
              <VolumeX className="w-[17px] h-[17px]" />
            )}
          </CtrlButton>
